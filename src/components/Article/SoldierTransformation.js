    ...
    return (
        <Table bordered striped size="sm" className="auto-width">
            ...
            <tbody>
                ...
                <BooleanValue label="Allow Below Minimum Results?" value={transform.lowerBoundAtMinStats ?? true}/>
                ...
                <BooleanValue label="Upper Bound Calculation?" value={transform.upperBoundType}/>
            </tbody>
