...
import { SimpleValue, BooleanValue, Percent } from "../../ComponentUtils.jsx";
import { defaultDTProps as defaultProps } from "../../../model/Constants.js";
import { getBlastRadiusObj } from "../../../model/utils.js";
...
export default function DamageAlter({ type, alter, lc, blastRadius, melee, ruleset }) {
    const blastRadiusObj = getBlastRadiusObj(alter, blastRadius);
