...
import { ListHeader, ListValue, Money, SectionHeader, SimpleValue } from "../../ComponentUtils.jsx";
import SpawnedSoldier from "./SpawnedSoldier.jsx";
...
export default function Manufacture({ ruleset, lang, id, version }) {
    ...
    return (
        <Table bordered striped size="sm" className="auto-width">
            ...
            <SpawnedSoldier {...{ lc, linkFn, inventoryFn, ruleset }} label="Spawned Soldier" type={manufacture.spawnedPersonType} data={manufacture.spawnedSoldier} />
