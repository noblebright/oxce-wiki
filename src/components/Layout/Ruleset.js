                ...
                <Col>
                    <Navbar bg="dark" variant="dark">
                        ...
                        <NavDropdown title={possibleLanguages[lang]} rootCloseEvent="click">
                            { result.supportedLanguages.map(key => <NavDropdown.Item key={key} onClick={() => setLanguage(key)}>{possibleLanguages[key]}</NavDropdown.Item>) }
                        </NavDropdown>
                        <OptionsDropdown title={<Gear/>}>
                            <NavDropdown.Item>Clear Local DB</NavDropdown.Item>
                        </OptionsDropdown>
                    </Navbar>
                </Col>
            </Row>
