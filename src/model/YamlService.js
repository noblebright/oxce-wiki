...
export const mergeSection = (ruleset, name, sectionName, entry) =>
  Object.assign(
    {},
    deepmerge(ruleset[name][sectionName], entry, { clone: false, customMerge })
  );
export const mergeList = (list) =>
  list.reduce((acc, obj) => deepmerge(acc, obj, { clone: false }));
...
export function parse(text, url) {
  try {
